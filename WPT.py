...
def tokenize_test_file(test_data, tokenizer):
    tokenized_dict = {}
    for id_key,sentence in test_data.items():
        tokenized_dict[id_key] = tokenizer.tokenize(sentence)
...
if __name__ == "__main__":
    ...
    test_file = "test_corpus.json"  # File containing id-sentence pairs
    ...
    vocab = tokenizer.construct_vocabulary(corpus, group_no=18, vocab_size=7000)
